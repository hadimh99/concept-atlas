...
const APP_UPDATES = [{ version: "v2.9.1", date: "March 3, 2026", changes: ["Eradicated the notorious 'dotted circle' bug by migrating the Madinah script to the highly optimized me_quran web font, ensuring perfect compatibility with standard Unicode text."] }, { version: "v2.9.0", date: "March 3, 2026", changes: ["The Holy Grail of Fonts: Successfully wired the app directly into AlQuranCloud API servers to pull the authentic Uthmanic Hafs (Madinah) font."] }, { version: "v2.8.0", date: "March 3, 2026", changes: ["Added the official KFGQPC Uthman Taha (Madinah) script as the default Quran font."] }];
    ...
    <div className={`min-h-screen w-full overflow-hidden transition-colors duration-700 flex flex-col ${appBgClass}`}>
      <style>{`
        ...
        @font-face {
          ...
          src: url('https://cdn.alquran.cloud/public/fonts/me_quran-1.036.woff2') format('woff2'),
               url('https://cdn.alquran.cloud/public/fonts/me_quran-1.036.woff') format('woff');
          font-weight: normal;
          font-style: normal;
          font-display: swap;
        }
